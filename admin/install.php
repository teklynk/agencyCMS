...
unset($_SESSION["user_name"]);
	...
	if (!empty($_POST)) {
		...
		$filename = '../db/bootstrapagency.sql';
		// MySQL host
        ...
        $dbfile = fopen("../db/dbconn.php", "w") or die("Unable to open file!");
    ...
    <div class="row">
        <form name="frmUser" class="form-signin" method="post" action="">
          <h2 class="form-signin-heading">Database info</h2>
            ...
            <input class="form-control" type="text" name="dbserver" placeholder="DB Server" required focus>
